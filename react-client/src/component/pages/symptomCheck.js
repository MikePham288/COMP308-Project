  ...
  if (symptomCount.count === 0) {
    ...
    message = (
      <h2 className="text-danger">
        Severe Allergies (see a pharamcist and get some medicene)
      </h2>
    );
  } else if (
    symptomCount.count === 6 ||
    symptomCount.count === 5 ||
    symptomCount.count === 4
  ) {
    message = (
      <h2 className="text-warning">
        Cold (Take some medicene and call the doctor)
      </h2>
    );
    ...
    <div>
      <div className="card-container">
        <div className="row justify-content-center">
          <h2>
            <span className="text-primary">Symptom Check</span>
          </h2>
        </div>
        <div className="row justify-content-center">
          <h5>
            Specify Your Symptoms and know the possible medical condition you
            may have
          </h5>
        </div>
        ...
        <div className="row justify-content-center row-padding">{message}</div>
